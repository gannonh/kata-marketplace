...
```bash
VERIFICATION_TEMPLATE_PATH=$(node "${CLAUDE_PLUGIN_ROOT}/skills/kata-verify-work/scripts/kata-lib.cjs" resolve-template "verification-report.md")
...
```bash
EXTRA_CMDS_JSON=$(node "${CLAUDE_PLUGIN_ROOT}/skills/kata-verify-work/scripts/kata-lib.cjs" read-pref "workflows.verify-work.extra_verification_commands" "[]")
```
