...
**Purpose:** Answer "which library/option should we use" questions during mandatory discovery in phase-plan.

For deep ecosystem research ("how do experts build this"), use `/kata:phase-research` which produces RESEARCH.md.
...
- Use `/kata:phase-research` for these
</guidelines>
