...
Exit skill and invoke SlashCommand("/kata:phase-plan [X+1]")
...
**Also available:**
- `/kata:phase-discuss [X+1]` — gather context first
- `/kata:phase-research [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/kata:milestone-complete {version}")
