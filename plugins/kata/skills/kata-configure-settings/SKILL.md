...
```bash
node "${CLAUDE_PLUGIN_ROOT}/skills/kata-configure-settings/scripts/kata-lib.cjs" set-config "workflows.execute-phase.post_task_command" "$NEW_POST_TASK_CMD"
node "${CLAUDE_PLUGIN_ROOT}/skills/kata-configure-settings/scripts/kata-lib.cjs" set-config "workflows.execute-phase.commit_style" "$NEW_COMMIT_STYLE"
node "${CLAUDE_PLUGIN_ROOT}/skills/kata-configure-settings/scripts/kata-lib.cjs" set-config "workflows.execute-phase.commit_scope_format" "$NEW_SCOPE_FMT"
node "${CLAUDE_PLUGIN_ROOT}/skills/kata-configure-settings/scripts/kata-lib.cjs" set-config "workflows.verify-work.extra_verification_commands" "$NEW_EXTRA_CMDS"
node "${CLAUDE_PLUGIN_ROOT}/skills/kata-configure-settings/scripts/kata-lib.cjs" set-config "workflows.complete-milestone.version_files" "$NEW_VERSION_FILES"
node "${CLAUDE_PLUGIN_ROOT}/skills/kata-configure-settings/scripts/kata-lib.cjs" set-config "workflows.complete-milestone.pre_release_commands" "$NEW_PRE_RELEASE"
```
...
if ! bash "${CLAUDE_PLUGIN_ROOT}/skills/kata-configure-settings/scripts/setup-worktrees.sh"; then
  echo "Error: Worktree setup failed. Reverting worktree.enabled to false."
  node "${CLAUDE_PLUGIN_ROOT}/skills/kata-configure-settings/scripts/kata-lib.cjs" set-config "worktree.enabled" "false"
fi
```
