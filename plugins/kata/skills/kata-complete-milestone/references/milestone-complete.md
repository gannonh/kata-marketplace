...
eval "$(bash "${CLAUDE_PLUGIN_ROOT}/skills/kata-complete-milestone/scripts/manage-worktree.sh" create release "v$VERSION")"
...
```bash
CHANGELOG_TEMPLATE_PATH=$(node "${CLAUDE_PLUGIN_ROOT}/skills/kata-complete-milestone/scripts/kata-lib.cjs" resolve-template "changelog-entry.md")
